...
interface TabsProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  intervalSelectField?: ReactElement;
  timespanSelectField?: ReactElement;
}

function Tabs({type, tabs, panels, intervalSelectField, timespanSelectField}: TabsProps): ReactElement {
  const styles = {
